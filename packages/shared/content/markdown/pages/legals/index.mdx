...
subNavItems:
  ...
  - { to: "/legals/#disclaimer", title: "Disclaimer" }
robots: "noindex,nofollow"
seo: {
  description: "The legal bits like copyright, disclaimer, privacy policy and terms of use of my site."
}
---
...
The below icons are licensed by Font Awesome under the <a rel="nofollow,license" href="https://fontawesome.com/license/free" target="_blank">Font Awesome Free License (Icons — CC BY 4.0 License)</a>:

- Social (Twitter, LinkedIn, NPM, GitHub)
- UI (Chevron Right Solid, Arrow Down Solid)
