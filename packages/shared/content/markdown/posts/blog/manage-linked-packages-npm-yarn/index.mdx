...
taxonomy:
  ...
  - "npm"
seo: {
  description: "manage-linked-packages is a tool to help you find, list and reset npm and Yarn global linked (`link`) packages, manually on the command-line or programmatically in scripts."
}
---
